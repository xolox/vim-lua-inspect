...
function! xolox#luainspect#misc#buffer#is_empty() " {{{1
...
function! xolox#luainspect#misc#buffer#prepare(...) " {{{1
  ...
  for bufnr in tabpagebuflist()
    if xolox#luainspect#misc#path#equals(options['path'], bufname(bufnr))
  ...
  if !(found || xolox#luainspect#misc#buffer#is_empty())
    vsplit
  endif
  ...
  call xolox#luainspect#misc#buffer#unlock()
  silent %delete
endfunction

function! xolox#luainspect#misc#buffer#lock() " {{{1
  " Lock a special buffer so that its contents can no longer be edited.
  setlocal readonly nomodifiable nomodified
endfunction

function! xolox#luainspect#misc#buffer#unlock() " {{{1
