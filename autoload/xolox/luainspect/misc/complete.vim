...
function! xolox#luainspect#misc#complete#keywords(arglead, cmdline, cursorpos)
  ...
  "
  "     :command -nargs=* -complete=customlist,xolox#luainspect#misc#complete#keywords MyCmd call s:MyCmd(<f-args>)
  let words = {}
