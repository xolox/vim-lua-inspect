...
function! xolox#luainspect#misc#escape#pattern(string) " {{{1
...
function! xolox#luainspect#misc#escape#substitute(string) " {{{1
  " Takes a single string argument and converts it into a [:substitute]
...
function! xolox#luainspect#misc#escape#shell(string) " {{{1
